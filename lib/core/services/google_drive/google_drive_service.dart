...
class GoogleDriveService {
  ...
  var signedIn = false;
  static const _folderName = "DiaryBackups";
  ...
  Future<void> restoreBackupFromGoogleDrive() async {
    ...
    final query =
        "'$folderId' in parents and mimeType != 'application/vnd.google-apps.folder' and name contains 'diary_backup_'";
  ...
  //           ),
  //           Expanded(
  //             child: Text(list.files![i].name.toString()),
  //           ),
  //           Container(
  ...
  //               ),
  //               onPressed: () {
  //                 _downloadGoogleDriveFile(list.files![i].name.toString(),
  //                     list.files![i].id.toString());
  //               },
  //             ),
  //           ),
  //         ],
